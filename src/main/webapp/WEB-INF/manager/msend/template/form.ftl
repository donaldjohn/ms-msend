    ...
    <@ms.panel>
    	<@ms.form name="templateForm" isvalidation=true>
    		<@ms.hidden name="templateId" value="${templateEntity.templateId?default('')}"/>
    			...
    			<@ms.text label="" name="templateMail" value="${templateEntity.templateMail?default('')}"  width="240px;" placeholder="请输入" validation={"required":"true","maxlength":"50","data-bv-stringlength-message":"长度不能超过五十个字符长度!", "data-bv-notempty-message":"必填项目"}/>
    			<@ms.text label="" name="templateSms" value="${templateEntity.templateSms?default('')}"  width="240px;" placeholder="请输入" validation={"required":"true","maxlength":"50","data-bv-stringlength-message":"长度不能超过五十个字符长度!", "data-bv-notempty-message":"必填项目"}/>
